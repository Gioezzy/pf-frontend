...
export default function RegistrationsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="relative overflow-hidden rounded-none bg-gradient-to-br from-[#5C7C99]/20 via-[#5C7C99]/5 to-background border p-8 transition-all duration-500 hover:shadow-lg hover:border-[#5C7C99]/40 border-[#5C7C99]/20 group">
